...
if (-not $LegacyForeground) {
    Write-Warning "start_gateway.ps1 is now a legacy debug entry point. Delegating to .\\claude2openai.ps1 start --skip-smoke. Use -LegacyForeground to run only the gateway in the foreground."
